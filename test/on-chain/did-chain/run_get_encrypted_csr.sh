...
OUT_JSON="resultGetEncryptedCSR.json"
OUT_CSV="resultGetEncryptedCSR.csv"

RUN_JSON="resultGetEncryptedCSR_run.json"
RUN_CSV="resultGetEncryptedCSR_run.csv"
...
for RATE in "${RATES[@]}"; do
  echo "Running get_encrypted_csr RATE=$RATE"
  ...
  k6 run \
    ...
    testGetEncryptedCsr.js > /dev/null
