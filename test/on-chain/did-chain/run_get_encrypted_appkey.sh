...
OUT_JSON="resultGetEncryptedAppKey.json"
OUT_CSV="resultGetEncryptedAppKey.csv"

RUN_JSON="resultGetEncryptedAppKey_run.json"
RUN_CSV="resultGetEncryptedAppKey_run.csv"
...
for RATE in "${RATES[@]}"; do
  echo "Running get_encrypted_appkey RATE=$RATE"
  ...
  k6 run \
    ...
    testGetEncryptedAppKey.js > /dev/null
