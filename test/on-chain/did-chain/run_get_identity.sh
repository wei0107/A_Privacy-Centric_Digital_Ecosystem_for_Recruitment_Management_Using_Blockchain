...
OUT_JSON="resultGetIdentity.json"
OUT_CSV="resultGetIdentity.csv"

RUN_JSON="resultGetIdentity_run.json"
RUN_CSV="resultGetIdentity_run.csv"
...
for RATE in "${RATES[@]}"; do
  echo "Running get_identity_contract RATE=$RATE"
