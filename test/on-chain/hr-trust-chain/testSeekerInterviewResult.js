...
// 如果你的後端還會查 DB interviewId，請改成真實 interviewId
//const INTERVIEW_ID = __ENV.INTERVIEW_ID || 'dummyInterviewId';
const INTERVIEW_ID='69eb9cf021d89deb69ce5f48';
...
function buildChainPayload(iter) {
  return {
    position: 'SWE',
    company: 'TestCo',
    department: 'R&D',
    companyAddress: '0x123',
    result: iter % 2 === 0 ? 'pass' : 'fail',
  };
}
...
export default function () {
  ...
  const chainPayload = buildChainPayload(__ITER);
...
export function handleSummary(data) {
  ...
  const textLines = [
    'Seeker interview result summary',
    '===============================',
  ...
  return {
    ...
    'resultSeekerInterview_run.json': JSON.stringify(row, null, 2),
    'resultSeekerInterview_run.csv': `${csvHeader}\n${csvRow}\n`,
  };
}