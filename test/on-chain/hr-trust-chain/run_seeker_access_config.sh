...
OUT_JSON="resultSeekerAccessConfig.json"
OUT_CSV="resultSeekerAccessConfig.csv"

RUN_JSON="resultSeekerAccessConfig_run.json"
RUN_CSV="resultSeekerAccessConfig_run.csv"
...
for RATE in "${RATES[@]}"; do
  echo "Running seeker_access_config RATE=$RATE"
  ...
  k6 run \
    ...
    testSeekerAccessConfig.js > /dev/null
